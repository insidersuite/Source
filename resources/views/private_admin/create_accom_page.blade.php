											...
											<div class="row">
											    ...
											    <div class="col-xs-12 col-sm-6">
											        <div class="form-group">
											            ...
											            <input type="number" name="timestamp" id="timestamp" class="form-control" value="{{$accom['timestamp']}}">
											        </div>
											    </div>
											</div>
											<div class="row">
											    <div class="col-xs-12 col-sm-6">
												<div class="form-group">
											            <label for="">Min Days Booking</label>
											            <input type="text" name="min_day_booking" id="min_day_booking" class="form-control" @if($accom['min_day_booking'] == null) placeholder="input min day booking" @endif value="{{$accom['min_day_booking']}}" required>
											        </div>
											    </div>
											</div>
										</div>
							...
							<div class="col-xs-12">
								<div class="module type-upload-image">
									...
									<div class="upload-btn-wrapper">
										<div class="btn" id="slider_images">Add&Edit Slider Images</div>
									</div>
								</div>
							</div>
						</div>
...
<script type="text/javascript" src="{{ url('js/customize/admin_create_accom_page_4_20.js') }}"></script>
@endsection
