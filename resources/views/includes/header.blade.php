@if(Auth::User())
@if(Request::segment(1) == null || Request::segment(1) == 'offers' || Request::segment(1) == 'gift-card' || Request::segment(1) == 'credit' || Request::segment(1) == 'how-it-works' || Request::segment(1) == 'offer_detail' || Request::segment(1) == 'blog' || Request::segment(1) == 'sponsor' || Request::segment(1) == 'career' || Request::segment(1) == 'career_detail_info' || Request::segment(1) == 'blog_detail' || Request::segment(1) == 'career_detail' || Request::segment(1) == 'home' || Request::segment(1) == 'giving_review' || Request::segment(1) == 'confirm_review')
...
@endif
@elseif(Request::segment(1) == null || Request::segment(1) == 'blogs' || Request::segment(1) == 'blog-detail' || Request::segment(1) == 'career-detail' || Request::segment(1) == 'career-detail-info' || Request::segment(1) == 'signup' || Request::segment(1) == 'giving_review' || Request::segment(1) == 'confirm_review' || Request::segment(1) == 'how_it_works' || Request::segment(1) == 'careers' || Request::segment(1) == 'career-detail_info')
