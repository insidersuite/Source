...
.gallery-info-capacity::before {
    ...
    top: 1px;
    left: 1px;
    background-image: url(https://www.insidersuite.com/imgs/pamela.png);
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:;">
  ...
  <!-- /IMG TOP -->
  <tr>
  <td bgcolor="#ffffff"  class="p20"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody>
  <!-- titre -->
  <tr>
  <td align="center"><i style="font-size:28px; font-family: Georgia, serif; color:#1d1d1d;  font-style: italic;">Someone special would like you to join their journey. </i></td>
  </tr>
  <!-- /titre -->
  ...
  <tr>
      ...
      <td align="left"><i style="font-size:16px; font-family: Georgia, serif; color:#1d1d1d;  ">We are very exited to share the trip itinerary of {{$sender_name}}. 
        <br><br>
  ...
  <i style="font-size:16px; font-family: Georgia, serif; color:#1d1d1d;  ">
    We wish you the most thrilling adventures ahead!<br><br>
    Insider Suite Team
  </i>
  </tbody>
  </table></td>
