...
Route::group(['middlewareGroups' => 'web'], function () {
	...
	Route::group(['middleware' => 'Authenticated'], function() {
		...
		Route::post('experience-payment', 'ApiController@experiencePayment');
...
// 		Route::get('hotel/details/{id}','HotelController@hotel_details');
		...
		Route::get('experience_invite', 'HomeController@experience_invite');
		Route::get('payment_error_page', 'HomeController@payment_error_page');
		Route::get('payment_error_page_gift', 'HomeController@payment_error_page_gift');
		Route::get('create_exp_accoms', 'HomeController@create_exp_accoms');
		...
		Route::post('delete_accom_info', 'ApiController@delete_accom_info');
		...
		Route::post('delete_act_info', 'ApiController@delete_act_info');
		...
		Route::get('validate_calendar_accommodation', 'ApiController@validate_calendar_accommodation');
		Route::get('validate_calendar_activity', 'ApiController@validate_calendar_activity');
		// Dashboard - /dashboard
		...
		Route::get('admin/slider_images/{id?}', 'HomeController@slider_images');
		Route::get('admin/activity_slider_images/{id?}', 'HomeController@activity_slider_images');
		...
		Route::get('admin/delete_slider_image', 'ApiController@delete_slider_image');
		Route::get('admin/delete_activity_slider_image', 'ApiController@delete_activity_slider_image');
