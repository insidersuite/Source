      ...
      <div class="_typbqzd">
        <div class="_c0gjcf">
          ...
          <div style="margin-top: 16px; margin-bottom: 16px;">
            <div style="margin-top: 16px; margin-bottom: 16px;">
<div class="_ncwphzu"> We're very <b>excited </b>to have you on board!</b></div>
            </div>
            <div style="margin-top: 16px; margin-bottom: 16px;">
            <div class="_ncwphzu">Get ready to jump into exclusive offers of <b>formidable accommodations</b> and <b>unique activities</b>, specially negotiated and packaged for the unconventional traveler like you!
            </div>
            </div>
          </div>
          <div>
            <div style="margin-top: 32px; margin-bottom: 32px;">
              <button type="button" id="next_step0" class="btn next" aria-busy="false"><span class="_cgr7tc7"><span>Discover</span></span></button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="step1">
      <div class="_1dnc5pl">
        <div class="_1b08ubc">
          <div class="_1l4vj07">
            <div class="_12ei9u44"> Fasten your seatbelt! It's time to get your trip on fire… 🔥 </div>
          </div>
        </div>
      </div>
      <div class="_1afoiga">
    ...
    <div class="step3">
      ...
      <div class="_ugd6bx">
        <div class="_1f6oxkn">
          <div class="_10105j3">
            <div class="_e296pg" style="width: 100%; height: 100%;">
              <div class="_6ikqekk" role="img" aria-label="not-looking-for" style="width: 100%; height: 100%; background-image: url('images/Background/discover-2.jpg');"></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="step4">
      <div class="_1dnc5pl">
        <div class="_1b08ubc">
          <div class="_1l4vj07">
            <div class="_12ei9u44"> Every great journey begins with a dream. We would like to learn more about your dreams! ⭐</div>
          </div>
        </div>
      </div>
      <div class="_1afoiga">
      ...
      <div class="step-content">
        <div class="works">
          ...
          <div class="profile-content">
            ...
            <div class="message">
            <h4>Countries in your bucket list:</h4>
                <input id="indicate" >
                <h4>How often do you travel?</h4>
                <input id="indicate_travel" placeholder="Input the frequency">
                <h4>Your favourite travel buddy’s email address:</h4>
                <input id="travel_buddy">
                <h4>Most exciting activity you could think of:</h4>
    ...
    <div class="step7">
      <div class="_typbqzd">
        <div class="_c0gjcf">
          <div>
            <div class="_12ei9u44"> Let’s create your experience! </div>
          </div>
          <div style="margin-top: 16px; margin-bottom: 16px;">
            <div style="margin-top: 16px; margin-bottom: 16px;">
              <div>
            ...
            <div class="_gttisv7">Discover our destinations</div>
                <div class="_ncwphzu">  Receive the hottest deals with new destinations every month.</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div>
                <div class="_qtix31">
                  ...
                  <div class="_1thk0tsb">
                    ...
                    <div class="_ncwphzu">Book multiple accomodations and activities for your trip.</div>
                  </div>
                </div>
              </div>
            </div>
            <div style="margin-top: 16px; margin-bottom: 16px;">
              <div>
                <div class="_qtix31">
                  ...
                  <div class="_1thk0tsb">
                    <div class="_gttisv7">Share with your friends</div>
                    <div class="_ncwphzu">Invite your loved ones to join your trip and travel with a Spirit of Freedom!</div>
                  </div>
                </div>
              </div>
            </div>
            <div style="margin-top: 32px; margin-bottom: 32px;">
              <div><span><a id="create_experience" type="button" class="btn next" aria-busy="false"><span class="_cgr7tc7">Travel Now</span></a></span></div>
            </div>
          </div>
        </div>
      </div>
      <div class="_ugd6bx">
        <div class="_1f6oxkn">
          <div class="_10105j3">
            <div class="_e296pg" style="width: 100%; height: 100%;">
              <div class="_6ikqekk" role="img" aria-label="finish" style="width: 100%; height: 100%; background-image: url('/images/Background/discover-5.jpg');""></div>
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  ...
  if(navigator.platform == 'iPad' || navigator.platform == 'iPhone' || navigator.platform == 'iPod')
      {
            $("._1afoiga").css("margin-top", "400px");
            $("._1afoiga").css("position", "fixed");
      }
</script>
@endsection
