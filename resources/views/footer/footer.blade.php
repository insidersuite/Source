@if(Request::segment(1) == 'create_experience' || Request::segment(1) == 'experience_invite' || Request::segment(1) == 'payment_error_page' || Request::segment(1) == 'payment_error_page_gift')
@else
<div id="footer"></div>
	...
	<div class="row footer-content">
			...
			<div class="col-md-12">
				...
				<div class="col-md-10">
					...
					<div class="col-md-2 col-sm-12 footer-margin-top">
                         ...
                         <a @if(Auth::User()) href="{{ url('offers') }}" @else href="#" data-toggle="modal" data-target="#authentication" @endif><h4>Destinations</h4></a><br>
					...
					<div class="col-md-2 col-sm-12 footer-margin-top">
						...
						<a href="https://www.insidersuite-group.com" target="_blank"><h4  >Insider Suite Group</h4></a>
					</div>
				</div>
			</div>
		</div><br>
		<div class="row">
			...
			<div class="col-md-4 col-sm-12">
				...
				<!-- <div class="col-md-8 col-sm-4"><a href="@if(Auth::User()) {{ url('#') }} @else {{ url('#') }} @endif"><h4>PREMIUM PACKAGE</h4></a>
				</div> -->
				<div class="col-md-2 col-sm-4"></div>
			</div>
			<div class="col-md-4 col-sm-12"></div>
