						...
						<div class="request">
							<div class="world-conquest">
								...
								<p class="world-conquest-phrase">
                                    So many new places to explore! Let us know which city the Insider Suite collective should investigate for your next cool experience.
								</p>
								<p><a class="btn btn-info suggest_btn" href="mailto:contact@insidersuite.com">Suggest a city</a></p>
							</div>
						</div>
					</div>
				</div>@endif				
