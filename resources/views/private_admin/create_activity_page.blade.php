										...
										<div class="content type-default">
											...
											<div class="row">
												...
												<div class="col-xs-12 col-sm-6">
											        <div class="form-group">
											            ...
											            <input type="number" name="timestamp" id="timestamp" class="form-control" value="{{$activity['timestamp']}}">
											        </div>
											    </div>
											</div>
											...
											<div class="col-xs-12 col-sm-6">
											        <div class="form-group">
											            ...
											            <input type="text" name="min_capacity" id="min_capacity" class="form-control" @if($activity['min_capacity'] == null) placeholder="input min capacity" @endif value="{{$activity['min_capacity']}}" required>
											        </div>
											    </div>
											</div>
										</div>
                                            ...
                                            <div class="row">
												<div class="col-xs-12 col-sm-12">
													<div class="form-group">
														...
														<textarea class="form-control" name="there" id="there" required></textarea>
													</div>
												</div>                                            
											</div>
											<div class="row">
												<div class="col-xs-12 col-sm-12">
													<div class="form-group">
														<label for="">what else should we know?</label>
														<textarea class="form-control" name="know" id="know" required></textarea>
													</div>
												</div>                                            
											</div>
										</div>
							...
							<div class="col-xs-12">
								<div class="module type-upload-image">
									...
									<div class="upload-btn-wrapper">
										<div class="btn" id="slider_images">Add&Edit Slider Image</div>
									</div>
								</div>
							</div>
						</div>
...
<script type="text/javascript" src="{{ url('js/customize/admin_create_activity_page_4_19.js') }}"></script>
@endsection
