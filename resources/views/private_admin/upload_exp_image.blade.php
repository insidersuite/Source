				...
				<div class="col-xs-12 col-sm-12">
					<div class="content-box">
						<div class="boxes-list">
							<!-- fixed by dong -->
							@if(count($categories_datas) != 0)
								@foreach($categories_datas as $categories_data)
									@if(count($categories_data['data']) != 0)
										<div class="main-box">
										    <h1 style="text-transform: capitalize;">{{$categories_data['name']}} Images</h1>
										    <div class="row">										    	
										        @foreach($categories_data['data'] as $sel)
			...
			<div class="modal-body">
				<div class="row-modal">
					<div class="row">
						<div class="col-xs-12 col-sm-12">
							<!-- fixed by dong -->
							<input type="text" id="category" name="category" class="form-control" list="address_list" onkeyup="this.value = this.value.toLowerCase();" required>
