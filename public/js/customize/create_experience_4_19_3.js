                        ...
                        if (exp.check_in == exact_dates[k]) {
                            ...
                            acts_arr.forEach(act => {
                                ...
                                if (exp.guests_num == 1) {
                                    ...
                                    content[k] += "<div style='margin-left: 20px;width: 50%;'>" + "<h4>" + act.name + "</h4><p style='font-size: 16px;color: #a7a4a4;'>" + act.address + "</p><div class='gallery-info-data'><span style='width: 18px;height: 18px;top: 1px;left: 1px;background-image: url(https://www.insidersuite.com/imgs/pamela.png);'>" + exp.guests_num + " Guests coming</span></div></div>";
                                    mail_content[k] += "<div style='margin-left: 20px;width: 50%;'>" + "<h4>" + act.name + "</h4><p style='font-size: 16px;color: #a7a4a4;'>" + act.address + "</p><div class='gallery-info-data'><span style='width: 18px;height: 18px;top: 1px;left: 1px;background-image: url(https://www.insidersuite.com/imgs/pamela.png);'>" + exp.guests_num + " Guests coming</span></div></div>";
                                }
