					...
					<div class="content-box">						
						<div class="header-list">
							<div class="row">
                                ...
                                <div class="label-table min_capacity">Min guest</div>
						...
						<div class="item-list">
							...
							<div class="item">
								<div class="row">
                                    <div class="label-table city">{{$data->city_id}} <a class="edit" data-id="{{$data->id}}">Edit</a> 
                                    	<!-- <a class="delete" data-id="{{$data->id}}">Delete</a> -->
                                    </div>
									<div class="label-table name">{{$data->name}}</div>
									<div class="label-table address">{{$data['address']}}</div>
                                    <div class="label-table min_capacity">{{$data->min_capacity}}</div>
                                    <div class="label-table status">{{$data->status}}</div>
                                    <div class="label-table sort">{{$data->timestamp}}</div>
								</div>
							</div>
							@endforeach
							<!-- fixed by Dong -->
							<?php $current_id = $_GET['id']; ?>							
							{{$datas->appends(['id' => $current_id])->links()}}   
							<!-- fixed end --> 
						</div>
					</div>
				</div>
