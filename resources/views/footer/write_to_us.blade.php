			...
			<div id="accordion">
				<div class="card">
					<div class="card-header" id="heading1">
						<div class="custom_flex mb-0" data-toggle="collapse" data-target="#collapse1" aria-expanded="true" aria-controls="collapse1">
					...
					<div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordion">
						<div class="card-sub">
							<div class="card-header" id="sub_heading1">
								<div class="custom_flex mb-0" data-toggle="collapse" data-target="#sub_collapse1" aria-expanded="true" aria-controls="sub_collapse1">
							...
							<div id="sub_collapse1" class="collapse collapse_text" aria-labelledby="sub_heading1" data-parent="#accordion">
								<span>The following payment methods are accepted on Insider Suite:<br>
									• Debit Card<br>
									• Visa card<br>
									• Mastercard<br>
									• Visa electron<br>
						...
						<div class="card-sub">
							<div class="card-header" id="sub_heading2">
								<div class="custom_flex mb-0" data-toggle="collapse" data-target="#sub_collapse2" aria-expanded="true" aria-controls="sub_collapse2">
						...
						<div class="card-sub">
							<div class="card-header" id="sub_heading3">
								<div class="custom_flex mb-0" data-toggle="collapse" data-target="#sub_collapse3" aria-expanded="true" aria-controls="sub_collapse3">
						...
						<div class="card-sub">
							<div class="card-header" id="sub_heading4">
								<div class="custom_flex mb-0" data-toggle="collapse" data-target="#sub_collapse4" aria-expanded="true" aria-controls="sub_collapse4">
							...
							<div id="sub_collapse4" class="collapse collapse_text" aria-labelledby="sub_heading4" data-parent="#accordion">
								Gift cards and travel vouchers can be used to cover all, or part, of the holiday
								  ...
								  booking.<br><br><b><u>Travel vouchers:</u></b><br>For more information on how to earn travel vouchers please visit the Sponsor page at the bottom of our website page. The voucher, if valid on your account, can be selected and redeemed during the final stages of the booking process. Your debit or credit card will be charged the remaining balance.&nbsp;<span><br><br><b><u>Gift cards:</u></b><br></span>To redeem&nbsp;your gift card, you must first access your Online Member Account. Click on the gift card at the top right-hand corner. The gift card, if valid on your account, can be selected and redeemed during the final stages of the booking process. Your debit or credit card will be charged the remainder of the balance.&nbsp;<span><br><i><b>Important: gift cards are non-transferable, and are valid for 12 months from the date of purchase.</b></i></span>
							</div>
						</div>
					</div>
				</div>
				<div class="card">
					<div class="card-header" id="heading2">
						<div class="custom_flex mb-0" data-toggle="collapse" data-target="#collapse2" aria-expanded="true" aria-controls="collapse2">
					...
					<div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordion">
						<div class="card-sub">
							<div class="card-header" id="sub_heading5">
								<div class="custom_flex mb-0" data-toggle="collapse" data-target="#sub_collapse5" aria-expanded="true" aria-controls="sub_collapse5">
						...
						<div class="card-sub">
							<div class="card-header" id="sub_heading6">
								<div class="custom_flex mb-0" data-toggle="collapse" data-target="#sub_collapse6" aria-expanded="true" aria-controls="sub_collapse6">
							...
							<div id="sub_collapse6" class="collapse collapse_text" aria-labelledby="sub_heading6" data-parent="#accordion">
								You’ll find more info in our story page.
							</div>
						</div>
						<div class="card-sub">
							<div class="card-header" id="sub_heading7">
								<div class="custom_flex mb-0" data-toggle="collapse" data-target="#sub_collapse7" aria-expanded="true" aria-controls="sub_collapse7">
				...
				<div class="card">
					<div class="card-header" id="heading3">
						<div class="custom_flex mb-0" data-toggle="collapse" data-target="#collapse3" aria-expanded="true" aria-controls="collapse3">
					...
					<div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordion">
						<div class="card-sub">
							<div class="card-header" id="sub_heading8">
								<div class="custom_flex mb-0" data-toggle="collapse" data-target="#sub_collapse8" aria-expanded="true" aria-controls="sub_collapse8">
						...
						<div class="card-sub">
							<div class="card-header" id="sub_heading9">
								<div class="custom_flex mb-0" data-toggle="collapse" data-target="#sub_collapse9" aria-expanded="true" aria-controls="sub_collapse9">
				...
				<div class="card">
					<div class="card-header" id="heading4">
						<div class="custom_flex mb-0" data-toggle="collapse" data-target="#collapse4" aria-expanded="true" aria-controls="collapse4">
					...
					<div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordion">
						<div class="card-sub">
							<div class="card-header" id="sub_heading11">
								<div class="custom_flex mb-0" data-toggle="collapse" data-target="#sub_collapse11" aria-expanded="true" aria-controls="sub_collapse11">
						...
						<div class="card-sub">
							<div class="card-header" id="sub_heading13">
								<div class="custom_flex mb-0" data-toggle="collapse" data-target="#sub_collapse13" aria-expanded="true" aria-controls="sub_collapse13">
						...
						<div class="card-sub">
							<div class="card-header" id="sub_heading14">
								<div class="custom_flex mb-0" data-toggle="collapse" data-target="#sub_collapse14" aria-expanded="true" aria-controls="sub_collapse14">
						...
						<div class="card-sub">
							<div class="card-header" id="sub_heading15">
								<div class="custom_flex mb-0" data-toggle="collapse" data-target="#sub_collapse15" aria-expanded="true" aria-controls="sub_collapse15">
